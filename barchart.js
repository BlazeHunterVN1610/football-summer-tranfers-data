// JavaScript code for creating bar charts with dropdown menu to select different chart sets
document.addEventListener('DOMContentLoaded', function () {
  ...
  function loadDataAndDrawChart(year) {
    ...
    // Initial load and draw for the default selection (first option in the dropdown)
    loadDataAndDrawChart(d3.select("#chartSelect").property("value"));
});
